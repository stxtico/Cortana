...
**Phase:** 7 — CAD (done: A13 data pipeline; A14 generation loop -
tools/cad.py, geometric validation as ground truth over vision, gemma4:e4b's
vision path found broken and gemma3:12b substituted; next up is A15, the
character layer)
...
**Next**: A15 - the character layer, per PROMPTS.md's sequencing now that
A14 is done. A5b
