...
**Phase:** 7 — CAD (done: A13 data pipeline, cad/verified/bracket + 200
verified synthetic pairs; next up is A14, CAD generation with a
verification loop)
...
**Next**: A14 - CAD generation with a verification loop, per PROMPTS.md's
sequencing now that A13 is done. A5b
